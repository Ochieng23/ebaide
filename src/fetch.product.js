      ...
      productCollectionArray.map(item => {
        ...
        item.addEventListener("click", () => {
          ...
          setTimeout(() => {
            ...
            AddClassToNewElement(smallImageGroup, "smallImage-column");
            ...
            AddClassToNewElement(productPriceSpanHolder, "productPrice");
            ...
            addToCartButton.addEventListener("click", e => {
              ...
              const idOfItemAddToCart =
                addToCartButton.parentElement.parentElement.parentElement.parentElement.id;
