...
const CheckoutPage = () => {
  ...
  const vatTaxAmount = Math.floor(Math.random() * 1000);
  vatTaxValue.innerHTML = "Ksh. " + vatTaxAmount;
  AppendChildToDynamicElement(ordervatTax, vatTaxValue);
  AppendChildToDynamicElement(orderSummeryBodySection, ordervatTax);
